...
class Report(db.Model):
    ...
    case_run = db.Column(db.Integer(), nullable=True, comment='执行用例数')
    case_successes = db.Column(db.Integer(), nullable=True, comment='用例成功数')
    api_run = db.Column(db.Integer(), nullable=True, comment='执行api数')
    api_successes = db.Column(db.Integer(), nullable=True, comment='api成功数')
