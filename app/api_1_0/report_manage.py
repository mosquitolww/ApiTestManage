...
def find_report():
    ...
    end_data = [{'name': c.case_names, 'case_run': c.case_run, 'case_successes': c.case_successes, 'api_run': c.api_run,
                 'api_successes': c.api_successes, 'project_id': project_id, 'id': c.id, 'read_status': c.read_status,
